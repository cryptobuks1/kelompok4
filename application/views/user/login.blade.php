    ...
    <div class="container mt--8 pb-5">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <?= form_open('user/login/doLogin') ?>
                ...
                @endif
                <input type="hidden" name="{{ $secData['name'] }}" value="{{ $secData['key'] }}">
          ...
          <div class="row mt-3">
            <div class="col-6">
              <a href="{{ site_url('user/forgot_credentials') }}" class="text-light"><small>Forgot password?</small></a>
            </div>
            <div class="col-6 text-right">
              <a href="{{ site_url('user/register') }}" class="text-light"><small>Create new account</small></a>
            </div>
          </div>
        </div>
      </div>
