...
<table width="700" border="0" cellpadding="2" cellspacing="1" >
  ...
  <tr>
	...
	?>
     ...
     ?></td>
		 <td align="center"><a href="?page=barang_hapus&amp;Kode=<?php echo $Kode ?>" target="_self" alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA PENTING INI ... ?')"><img src="images/delete.png"></a>
